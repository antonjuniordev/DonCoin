DonCoin Core version 0.9.4 is now available from:

  http://doncoin.cc/bin/0.9.4/
...
this update is incompatible with the DonCoin system and could lead to consensus
forks.

DonCoin Core released binaries from http://doncoin.cc are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~doncoin/+archive/ubuntu/doncoin
- A third-party or self-compiled DonCoin Core

upgrade to DonCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
