DonCoin Core version 0.13.2 is now available from:
  ...
  <http://doncoin.cc/bin/doncoin-core-0.13.2/>
...
- #8908 `4a974b2` Update doncoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow doncoin-tx to create v2 transactions (btcdrak)
