DonCoin Core version 0.10.4 is now available from:

  <http://doncoin.cc/bin/doncoin-core-0.10.4/>
...
- #6953 `43c2789` Split doncoin-tx into its own package
- #6953 `dfe0d4d` Include doncoin-tx binary on Debian/Ubuntu
