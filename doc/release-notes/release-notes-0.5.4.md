DonCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/doncoin/files/DonCoin/doncoin-0.5.4/
...
http://gitorious.org/doncoin/doncoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix DonCoin-Qt notifications under Growl 1.3.
Increase required age of DonCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxDonCoin properly when installing DonCoin-Qt over it. (Windows)
