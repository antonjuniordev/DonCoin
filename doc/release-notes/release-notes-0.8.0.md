DonCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/doncoin/files/DonCoin/doncoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the DonCoin
...
New/changed settings (command-line or doncoin.conf file)
--------------------------------------------------------
