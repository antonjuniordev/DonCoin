...
This document provides guidelines for internationalization of the DonCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `doncoin_en.ts` remains unchanged.
