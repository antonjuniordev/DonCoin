...
unlocked to sign the DonCoin-Qt.app bundle.
...
allowing somebody to distribute a DonCoin-Qt.app or doncoin-qt-setup.exe with a valid
...
that the doncoin-qt.exe file inside the installer had not been tampered with.
