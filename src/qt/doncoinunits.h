...
#ifndef DONCOIN_QT_DONCOINUNITS_H
#define DONCOIN_QT_DONCOINUNITS_H
...
/** DonCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DonCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DonCoinUnits(QObject *parent);

    /** DonCoin units.
      @note Source: https://en.doncoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        DNC,
...
typedef DonCoinUnits::Unit DonCoinUnit;

#endif // DONCOIN_QT_DONCOINUNITS_H
