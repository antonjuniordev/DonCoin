...
#define HASH_FUNC_BASE_TIMESTAMP 1492973331 // DonCoin: Genesis Timestamp
#define HASH_FUNC_COUNT 10                   // DonCoin: HASH_FUNC_COUNT of 11
#define HASH_FUNC_COUNT_PERMUTATIONS 40320  // DonCoin: HASH_FUNC_COUNT!
