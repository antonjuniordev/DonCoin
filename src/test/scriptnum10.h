...
#ifndef DONCOIN_TEST_SCRIPTNUM10_H
#define DONCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from DonCoin Core 0.10.0, for cross-comparison.
 */
public:
