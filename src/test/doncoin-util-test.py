...
# Copyright 2016 The DonCoin Core developers
...
help_text="""Test framework for doncoin utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/doncoin-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/test/data", "doncoin-util-test.json", buildenv)
