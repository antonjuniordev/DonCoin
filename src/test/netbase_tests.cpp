// Copyright (c) 2012-2017 The DonCoin Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.doncoin.org", "www.doncoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.doncoin.org]", "www.doncoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.doncoin.org:80", "www.doncoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.doncoin.org]:80", "www.doncoin.org", 80));
