...
class RawTransactionsTest(DonCoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid doncoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid doncoin address" in e.error['message'])
